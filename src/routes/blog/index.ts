...
export default (router: Router) => {
  ...
  router.get(`${API_PREFIX}/blogs/search`, BlogController.searchBlogs);
  router.get(`${API_PREFIX}/admin/blogs`, BlogController.getAllBlogs);
  router.get(`${API_PREFIX}/blogs/:id`, BlogController.getBlogById);
  router.get(`${API_PREFIX}/admin/blogs/:id`, BlogController.getBlogById);
